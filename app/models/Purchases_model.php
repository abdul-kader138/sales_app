...
class Purchases_model extends CI_Model
{
    ...
    {
        $this->db->select('purchase_items.*, tax_rates.code as tax_code, tax_rates.name as tax_name, tax_rates.rate as tax_rate, products.unit, products.details as details, product_variants.name as variant, products.price as sale_price')
    ...
    public function addPurchase($data, $items, $prod_price)
    {
...
//                }
            ...
            foreach ($prod_price as $value) {
                $this->db->update('products', 
                        array('cost' => $value['real_unit_cost'], 'min_selling_price' => $value['min_selling_price'], 'landing_price' => $value['landing_price'], 'price' => $value['price']), 
    ...
    public function updatePurchase($id, $data, $items = array(), $prod_price)
    {
