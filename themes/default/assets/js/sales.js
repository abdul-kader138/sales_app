...
function loadItems() {
    ...
    if (localStorage.getItem('slitems')) {
        ...
        $.each(sortedItems, function () {
            ...
            tr_html += '<td class="text-right"><input class="form-control input-sm text-right rprice" name="net_price[]" type="hidden" id="price_' + row_no + '" value="' + item_price + '"><input class="ruprice" name="unit_price[]" type="hidden" value="' + unit_price + '"><input class="realuprice" name="real_unit_price[]" type="hidden" value="' + item.row.real_unit_price + '"><span class="text-right sprice" id="sprice_' + row_no + '">' +  ( formatMoney(item_price) != '0.00' ? formatMoney(item_price) : formatMoney(msp) != '0.00' ? formatMoney(msp) : formatMoney(item.row.cost) ) + '</span></td>';
            ...
            tr_html += '<td class="text-right"><span class="text-right ssubtotal" id="subtotal_' + row_no + '">' + formatMoney(((parseFloat(item_price != '0.00' ? item_price : msp != '0.00' ? msp : formatMoney(item.row.cost) ) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) + '</span></td>';
            ...
            total += formatDecimal(((parseFloat(item_price != '0.00' ? item_price : msp != '0.00' ? msp : formatMoney(item.row.cost)) + parseFloat(pr_tax_val)) * parseFloat(item_qty)), 4);
