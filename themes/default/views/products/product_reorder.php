...
//            return '('+formatQuantity2(v[0])+') <strong>'+formatMoney(v[1])+'</strong>';
        ...
        oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('products/getProductReorderReport/?v=1'.$v) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('product_reorder_report'); ?> <?php
            ?></h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("products/reorder_details"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('products/getProductReorderReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('products/getProductReorderReport/0/xls/?v=1'.$v)?>";
            return false;
        });
