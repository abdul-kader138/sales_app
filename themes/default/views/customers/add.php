            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input('customer_credit_limit', '', 'class="form-control" id="customer_credit_limit"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("credit_enjoy_days", "credit_enjoy_days"); ?>
                        <?php echo form_input('credit_enjoy_days', '', 'class="form-control" id="credit_enjoy_days"'); ?>
