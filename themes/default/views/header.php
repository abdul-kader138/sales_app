                ...
                <div class="container">
                    ...
                    <div class="header-nav">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown">
                                <a class="btn bdarkblue tip" id="attendance" title="<span><?= lang('attendance') ?></span>" data-placement="bottom" data-html="true" href="<?= site_url('time_scheduler') ?>" data-toggle="modal" data-target="#attendanceModal">
