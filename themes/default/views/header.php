...
<ul class="nav navbar-nav pull-right">
    <li class="dropdown hidden-xs"><a class="btn tip" title="<?= lang('dashboard') ?>" data-placement="bottom"
                                      href="<?= site_url('welcome') ?>"><i class="fa fa-dashboard"></i></a></li>
    <?php if ($Owner) { ?>
    ...
    <?php if ($Owner || $Admin) { ?>
        <?php if (POS) { ?>
            <li class="dropdown hidden-xs">
                <a class="btn bblue tip" title="<?= lang('list_open_registers') ?>" data-placement="bottom"
    ...
    <li class="mm_products">
        ...
        <ul>
            ...
            <li id="products_details_search">
                <a class="submenu" href="<?= site_url('products/details_search') ?>">
                    <i class="fa fa-filter"></i><span class="text"> <?= lang('product_details_search'); ?></span>
                </a>
            </li>
            <li id="products_reorder_details">
                <a class="submenu" href="<?= site_url('products/reorder_details') ?>">
                    <i class="fa fa-filter"></i><span class="text"> <?= lang('product_reorder_report'); ?></span>
                </a>
            </li>
        </ul>
    </li>
    ...
    <li class="mm_auth mm_customers mm_suppliers mm_billers">
        ...
        <ul>
            <?php if ($Owner) { ?>
                ...
                <li id="billers_index">
                    <a class="submenu" href="<?= site_url('billers/add'); ?>" data-toggle="modal"
                       data-target="#myModal">
        ...
        <ul>
            ...
            <li id="reports_time_schedule_report">
                <a href="<?= site_url('reports/time_schedule') ?>">
                    <i class="fa fa-clock-o"></i><span class="text"> <?= lang('Time Schedule Report'); ?></span>
                </a>
            </li>
        </ul>
    </li>
        ...
        <li class="mm_auth mm_customers mm_suppliers mm_billers">
            ...
            <ul>
                ...
                if ($GP['customers-add']) {
                    ?>
                    <li id="customers_index">
                        <a class="submenu" href="<?= site_url('customers/add'); ?>" data-toggle="modal"
                           data-target="#myModal">
                            <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('add_customer'); ?></span>
                        </a>
                    </li>
                ...
                if ($GP['suppliers-add']) {
                    ?>
                    <li id="suppliers_index">
                        <a class="submenu" href="<?= site_url('suppliers/add'); ?>" data-toggle="modal"
                           data-target="#myModal">
                            <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('add_supplier'); ?></span>
                        </a>
                    </li>
