            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" for="code_prefix"><?= lang("code_prefix"); ?></label>
                                <?= form_input('code_prefix', $Settings->code_prefix, 'class="form-control tip" id="code_prefix" required="required"'); ?>
                            </div>
                        </div>
                    </fieldset>
